*Скрпт исправляющий ошибку миграции IdentityServer автоинкремента Id*
...
GO
ALTER TABLE [dbo].[AspNetRoleClaims] DROP CONSTRAINT [PK_AspNetRoleClaims] WITH (ONLINE = OFF ) --write her contraint name
GO
...
GO
ALTER TABLE [dbo].[AspNetUserClaims] DROP CONSTRAINT [PK_AspNetUserClaims] WITH (ONLINE = OFF ) --write her contraint name
GO
